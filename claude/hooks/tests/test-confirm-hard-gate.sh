...
# --- ask: gh pr external operations via raw gh api ---
run_case ask 'gh api repos/o/r/pulls/12/comments/1/replies -f body="hi"'
run_case ask 'gh api repos/o/r/issues/12/comments -f body="hi"'
run_case ask 'gh api repos/o/r/pulls/12/reviews -f event=APPROVE'
run_case ask 'gh api repos/o/r/pulls/12/comments -F body=@file.txt'
run_case ask 'gh api repos/o/r/pulls/12/merge -X PUT'
run_case ask 'gh api --method POST repos/o/r/issues/12/comments -f body="hi"'
...
run_case pass 'gh api repos/o/r/pulls/12/comments'
run_case pass 'gh api repos/o/r/pulls/12/comments --jq .[].body'
run_case pass 'gh api repos/o/r/pulls/12/comments -X GET'
run_case pass 'gh api repos/o/r/pulls/12'
